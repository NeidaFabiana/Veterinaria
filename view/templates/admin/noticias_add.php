	...
	<div style="margin:80px auto">
		...
		<main class="app-content">
		  <div class="app-title">
			...
			<ul class="app-breadcrumb breadcrumb">
			  ...
			  <li class="breadcrumb-item">Noticia</li>
		...
		<div class="row">
			<div class="col-md-8 mx-auto">
			  <div class="tile">
				<h3 class="tile-title">Noticia</h3>
				<div class="tile-body">
				  <form role="form"  method="post">
					...
					<div class="tile-footer">
						...
						<a class="btn btn-secondary" href="<?php echo $this->url?>AdminNoticias"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
					</div>
