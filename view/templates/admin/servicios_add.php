				...
				<div class="tile-body">
				  <form role="form"  method="post">
					<div class="form-group">
					  ...
					  <input class="form-control" type="text" placeholder="Servicio" name="Servicio">
					</div>
					...
					<div class="tile-footer">
						...
						<a class="btn btn-secondary" href="<?php echo $this->url?>AdminServicios"><i class="fa fa-fw fa-lg fa-times-circle"></i>Cancelar</a>
					</div>
