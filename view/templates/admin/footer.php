		...
		<script type="text/javascript" src="<?php echo $this->asset?>assets/js/jquery.easing.1.3.js"></script>
		<!-- the mousewheel plugin - optional to provide mousewheel support -->
		<script type="text/javascript" src="<?php echo $this->asset?>assets/js/jquery.mousewheel.js"></script>
		<!-- the jScrollPane script -->
		<script type="text/javascript" src="<?php echo $this->asset?>assets/js/jquery.jscrollpane.min.js"></script>
		<script type="text/javascript" src="<?php echo $this->asset?>assets/js/jquery.transform-0.9.3.min_.js"></script>
