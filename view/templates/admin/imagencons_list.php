...
?>
			...
			<div class="mb_content">
				<h2>Imagenes Consejos</h2>
				
				
				
			<span style="float:right"><button id="but_add" class="btn btn-danger" href="<?php echo $this->base_url?>AdminCons/add">Add New Row</button></span>
			   ...
			   <?php $count = 0;?>
                        ...
                        <td><?php echo substr($listaImagem->getNombre(), 0,50)."...";?></td>      
                         ...
                         <td class="center" style='font-size:10px; font-weight: bold;'>
                                        <a href="<?php echo $this->base_url?>AdminCons/editImagenCons/<?php echo $listaImagem->getIdImagen();?>"><i class="fa fa-edit fa-2x"></i></a>

                                        <a href='<?php echo $this->base_url?>AdminCons/delImagenCons/<?php echo $listaImagem->getIdImagen();?>'>&#128465;</a>
                                    </td>
                        </tr>
					<?php endforeach; ?>
                          <?php endif;?>   
